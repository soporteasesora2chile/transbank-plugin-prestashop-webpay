...
### PHP 7.3 + Mariadb + Prestashop 1.7
...
Instala mkcert y configura el authority en tu maquina. Si usas firefox necesitaras seguir los pasos que se muestran en la consola.
...
Para probar con SSL abilitado, necesitas que Chrome Ignore los problemas con ssl
